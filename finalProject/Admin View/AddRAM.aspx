<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin View/MasterPage.Master" CodeBehind="AddRAM.aspx.cs" Inherits="finalProject.WebForm1" %>
                            ...
                            <li class="input-items">
                                <div class="input-items-wrapper">
                                    ...
                                    <div class="input-input">
                                        ...
                                        <div class="input-grp drop-down suffix">
                                            <div class="input-grp-text">
                                                <div class="input-grp-text-dropdown">
                                                    GB
                                                    <i class="fas fa-caret-down"></i>
                                                </div>
                                            </div>
